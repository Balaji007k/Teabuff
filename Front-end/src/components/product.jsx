...
function Product({ isAuthenticated, productsItem, category, HideNavbar }) {
  ...
  return (
    ...
    <div className='Product d-flex justify-content-center' id="Product_id">
      <div className='product-inner-box'>
        <OfferSlider HideNavbar={HideNavbar} OfferImage1={"assets/offer (1).jpg"} OfferImage2={"assets/offer (3).jpg"}/>
...
<OfferSlider HideNavbar={HideNavbar} OfferImage1={"assets/offer (2).jpg"} OfferImage2={"assets/offer (1).jpg"}/>
...
<OfferSlider HideNavbar={HideNavbar} OfferImage1={"assets/offer (3).jpg"} OfferImage2={"assets/offer (1).jpg"}/>
