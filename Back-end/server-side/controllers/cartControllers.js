...
//   try {
//     let newItem = null; // 👈 will store the newly added/updated item
...
//         items: [newItem]
//       };
//       usercart = await userCartModel.create(NewCart);
//     } else {
//       // If cart exists
//       const itemIndex = usercart.items.findIndex(item => item.productId === productId);
...
//         usercart.items[itemIndex].quantity = quantity;
//         usercart.items[itemIndex].likes = likes;
//         newItem = usercart.items[itemIndex]; // 👈 updated item
//       } else {
...
//     return res.json({
//         usercart,
//         newItem   // 👈 only send the new/updated item
//     });
